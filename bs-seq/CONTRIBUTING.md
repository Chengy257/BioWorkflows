...
- `--real-run` needs a full environment with bismark/bowtie2/samtools/trim-galore/fastqc/multiqc (i.e. the same as `workflow/environment.yaml`); use it when validating deployments on servers.
